...
public class EmpresaService {
	...
	public void makeForm() {
		makeForm(FORM_INSERT, new Empresa(), FORM_ORDERBY_DESCRICAO);
	}

	
	public void makeForm(int orderBy) {
		makeForm(FORM_INSERT, new Empresa(), orderBy);
	}

	
	public void makeForm(int tipo, Empresa produto, int orderBy) {
	...
	public Object insert(Request request, Response response) {
		...
		Empresa produto = new Empresa(-1, descricao, preco, quantidade, dataFabricacao, dataValidade);
	...
	public Object get(Request request, Response response) {
		...
		Empresa produto = (Empresa) produtoDAO.get(id);
	...
	public Object update(Request request, Response response) {
        int id = Integer.parseInt(request.params(":id"));
		Empresa produto = produtoDAO.get(id);
        String resp = "";       
